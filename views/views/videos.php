...
<<<<<<< HEAD
                    ...
                    echo '<a class="btn btn-primary pull-right btn-lg watch" onclick="onVideoClick(\'' . base_url() . '/' . $video->url . '\',this)">Watch now  <i class="fa fa-chevron-right"></i></a>';
...
<<<<<<< HEAD
                    ...
                    echo '<li><i class="lead" class="fa fa-caret-square-o-right"></i>';
