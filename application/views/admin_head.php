...
<!--                    <span class="icon-bar"></span>-->
<!--                </button>-->
<!--                <a href="--><?php //echo base_url()?><!--index.php/admin"><img class="navbar-brand " style="margin: 0; padding: 0; height: 58px; width: 80px" alt="Brand" src="--><?php //echo base_url();?><!--assets/images/ppl-logo.png"></a>-->
<!--            </div>-->
<!---->
...
<!--                    <li class="dropdown">-->
<!--                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="text-align: center; font-size: 18px; height: 58px; padding-top: 18px"><span class="glyphicon glyphicon-user"></span> <strong>--><?php //echo $instructor_name;?><!--</strong><span class="caret"></span></a>-->
...
<div class="wrapper">
    <header class="header">
        ...
        <div class="header-main container">
            <div class="logo col-md-4 col-sm-4 col-xs-3">
                <img id="logo" class="img-responsive center-block" src="<?php echo base_url() ?>/assets/images/ppl_logo.png" alt="Logo">
            </div>
            <div class="logo col-md-5 col-sm-5 col-xs-9">
                <img class="img-responsive pull-left" src="<?php echo base_url() ?>/assets/images/vicerrectorado.png" alt="Logo">
            </div>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <?php if(isset($video) or isset($contact) or isset($about) or isset($counsseling)){
                        echo '<li class="nav-item"><a href="'.base_url('index.php/admin/index').'">Home</a></li>';
                    }
                    else{
                        echo '<li class="nav-item active"><a href="'.base_url('index.php/admin/index').'">Home</a></li>';
                    }?>
                    <?php if(isset($about)){
                    ...
                    <?php if(isset($counseling)){
                        echo '<li class="nav-item active"><a href="'.base_url('index.php/counseling').'">Counseling <? echo base_url();?></a></li>';
                    }
                    else{
                        echo '<li class="nav-item"><a href="'.base_url('index.php/counseling').'">Counseling <? echo base_url();?></a></li>';
                    }?>
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false" href="#"><span class="glyphicon glyphicon-user"></span> <?php echo $instructor_name;?> <i class="fa fa-angle-down"></i></a>
