    ...
    <div class='panel-body'>
        <table class="table">
            ...
            if($evaluation[0]->Format == 'Default - Spanish'){
                ...
                echo "<tr><td class='construct'>Preparación</td><td>¿C&oacute;mo considera usted fue el rendimiento de <b>".$respondent[0]->Names." ".$respondent[0]->Surnames."</b> en la actividad de resoluci&oacute;n de problemas?</td><td class='scoreRadio'><input type='radio' name='q0' value='0' required></td><td class='scoreRadio'><input type='radio' name='q1' value='1' required></td><td class='scoreRadio'><input type='radio' name='q1' value='2'></td><td class='scoreRadio'><input type='radio' name='q1' value='3'></td><td class='scoreRadio'><input type='radio' name='q1' value='4'></td><td class='scoreRadio'><input type='radio' name='q1' value='5'></td></tr>";
            ...
            elseif($evaluation[0]->Format == 'Default - English'){
                ...
                echo "<form role='form' method='post' action=".base_url()."index.php/evaluation/homework_send/".$course[0]->Course_id."/".$evaluation[0]->Project."/".$evaluation[0]->Evaluation_number."/".$respondent[0]->Registration_number.">";
                echo "<tr><td class='construct'>Preparation</td><td>How do you consider was the performance of <b>".$respondent[0]->Names." ".$respondent[0]->Surnames."</b> in the problem solving activity?</td><td class='scoreRadio'><input type='radio' name='q0' value='0' required></td><input type='radio' name='q1' value='1' required></td><td class='scoreRadio'><input type='radio' name='q1' value='2'></td><td class='scoreRadio'><input type='radio' name='q1' value='3'></td><td class='scoreRadio'><input type='radio' name='q1' value='4'></td><td class='scoreRadio'><input type='radio' name='q1' value='5'></td></tr>";
                echo "<tr><td colspan='7' style='text-align: center'><input class='btn btn-primary' type='submit' value='Send'></td></tr>";
                echo "</form>";
            }
            ?>
