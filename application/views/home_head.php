        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    if(isset($contact) or isset($about)){
                        echo '<li class="nav-item"><a href="'.base_url().'">Home</a></li>';
                    }
                    else{
                    ...
                    <li class="nav-item"><a href="https://www.pearsonhighered.com/products-and-services/course-content-and-digital-resources/learning-applications/learning-catalytics.html">Learning Catalytics</a></li>
                     <?php if(isset($about)){
