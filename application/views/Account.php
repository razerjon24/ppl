    ...
    public function forgot(){
        if($_POST){
            ...
            elseif(count($_POST)==1){
                ...
                $email_body = "Hello!<br><br>Since you have forgot your password, a link to verify your account have been sent to you.<br><br>Link: http://ppl.espol.edu.ec/index.php/account/forgot?user=".$username."&key=".$key;
                $this->email->from('ppl@espol.edu.ec', 'ppl');
                $this->email->to($username);
                $this->email->subject('Forgot password PPL');
                $this->email->message($email_body);
